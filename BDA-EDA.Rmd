...
```
In the data, We have 415 students who doesn't have a labour father and the rest 194 students do have a labour father. 
...
```
There is not much difference on this boxplot comparing students father is labour or not.
...
```{r}
ggplot(data = BDA, mapping = aes(x = MathScore)) + 
